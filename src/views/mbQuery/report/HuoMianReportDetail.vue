      ...
      <el-button class="back-btn" type="primary" @click="back">返回</el-button>
        ...
        <div class="info-title">基本信息</div>
         <div class="info-content">
            ...
            <div class="info-items">
              <div class="info-item"><span class="name">联系人电话:</span><span>{{datas.htwlWasteOperateYearReport.telephone}}</span></div>
            ...
            <div class="info-items">
              <div class="info-item"><span class="name">法定代表人:</span><span>{{datas.htwlWasteOperateYearReport.legalPerson}}</span></div>
              <div class="info-item"><span class="name">国民经济行业分类:</span><span>{{datas.htwlWasteOperateYearReport.entecategoryname}}</span></div>
...
export default {
    ...
    initPage(){
         let self = this;
      self.$api.mbQueryApi.huoMianReportDetail(self.objectId)
      .then((resp => {

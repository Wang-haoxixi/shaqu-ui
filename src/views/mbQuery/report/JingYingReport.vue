<template>
  <el-card class="main-container">
    ...
    <el-form :model="searchForm" label-width="100px" :inline="true">
      ...
      <el-button type="primary" @click="initData" style="margin-left:100px">查询</el-button>
    </el-form>
    </template>
    ...
    >
      ...
      <el-table-column prop="caculYear" label="年报年份"
      > </el-table-column>
      <el-table-column prop="proccessStatusName" label="填报状态"
      ></el-table-column>
...
export default {
  data() {
    return {
      ...
      statusList: [
        ...
        { code: "P2", name: "待备案", id: 278 },
        { code: "P3", name: "退回", id: 278 },
        { code: "P4", name: "区级备案通过", id: 278 },
        { code: "P5", name: "市级备案通过", id: 278 },
      ],
      zStreetList: [],
      uploadStatusList: [
        { code: "", name: "全部", id: 274 },
        { code: "YES", name: "上报成功", id: 274 },
        { code: "NO", name: "上报失败", id: 275 },
      ],
      tableData: [],
      pageInfo: {
        curPage: 1,
  ...
  methods: {
    getStatusDealList() {
      this.$api.dictionariesApi.getStatusDealList().then((res) => {
        this.statusList = res;
      });
    },
    getTrsAreaList() {
    ...
    initData() {
      let self = this;
      self.loading = true;
      self.$api.mbQueryApi.jingYingReportList({
    ...
    detailRow(id){
         this.$router.push({
            path: '/mbQuery/report/jingYingReportDetail',
            query: {id:id},
        });
    },
    ...
    sortYear(ob1,ob2){
      return ob1.caculYear<ob2.caculYear ? 1 : -1;
    }
  },
  created () {
      this.initData();
      this.getStatusDealList();
      this.getTrsAreaList();
  },
};
</script>

<template>
  <el-card class="main-container" >
      <el-button class="back-btn" type="primary" @click="back">返回</el-button>
        ...
        <div class="info-title">医废信息</div>
        <div class="info-content">
            <el-table border :data="datas.htwlWasteDangerReportWasteInfoList">
              <el-table-column type="index" label="序号"> </el-table-column>
              <el-table-column prop="wasteCode" label="医疗废物代码"> </el-table-column>
              <el-table-column prop="wasteName" label="医疗废物名称"> </el-table-column>
              <el-table-column prop="wasteTypeName" label="医疗废物类别"> </el-table-column>
          ...
          <div v-if="datas.htwlWasteDangerOuter.length">
            ...
            <div class="info-content">
                ...
                <el-table-column prop="entrustEpCityCode" label="行政区域代码"> </el-table-column>
...
export default {
    ...
    initPage(){
         let self = this;
      self.$api.mbQueryApi.yiLiaoReportDetail(self.objectId)
      .then((resp => {

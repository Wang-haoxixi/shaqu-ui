<template>
  <el-card class="main-container">
    ...
    <div>
      ...
      <div class="ent-info-item">
        <div class="ent-info-name">磅秤编号：</div>
        <div class="ent-info-des">{{ detail.scaleCode || "-" }}</div>
      </div>
      <div class="ent-info-item">
        <div class="ent-info-name">入库日期：</div>
        <div class="ent-info-des">
          {{ detail.intoDate || "-" }}
        </div>
      </div>
      <div class="ent-info-item">
        <div class="ent-info-name">暂存库：</div>
        <div class="ent-info-des">
          {{ detail.tsWarehouseName || "-" }}
        </div>
      </div>

      <div class="ent-info-item">
        <div class="ent-info-name">产生企业：</div>
        <div class="ent-info-des">
